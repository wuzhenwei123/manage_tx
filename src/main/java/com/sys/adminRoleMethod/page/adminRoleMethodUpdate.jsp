    ...
    <div class="wrapper wrapper-content animated fadeInRight">
    	<div class="panel">
			    ...
			    <div class="row">
			    	<div class="col-sm-12">
                		<div class="form-group">
                             ...
                             <div class="col-sm-8">
                                 <input id="id" name="id" value="${adminrolemethod.id}" class="form-control" type="text">
                		...
                		<div class="form-group">
                             ...
                             <div class="col-sm-8">
                                 <input id="roleId" name="roleId" value="${adminrolemethod.roleId}" class="form-control" type="text">
                                 <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> <spring:message code="sys.main.required" /></span>
                             </div>
                         </div>
                		<div class="form-group">
                             ...
                             <div class="col-sm-8">
                                 <input id="mid" name="mid" value="${adminrolemethod.mid}" class="form-control" type="text">
                                 <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> <spring:message code="sys.main.required" /></span>
                             </div>
                         </div>
                		<div class="form-group">
                             ...
                             <div class="col-sm-8">
                                 <input id="columnId" name="columnId" value="${adminrolemethod.columnId}" class="form-control" type="text">
                                 <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> <spring:message code="sys.main.required" /></span>
                             </div>
                         </div>
			    	</div>
    		...
    		<div class="panel-footer text-center">
    			<button type="submit" class="btn btn-primary"><spring:message code="sys.main.update" /></button>
	    ...
	    $(document).ready(function() {
	        ...
	        $("#commentForm").validate({
	            ...
	            submitHandler : function(){
	            	...
	            	$.ajax({
	            		url:"${ctx}/adminRoleMethod/updateAdminRoleMethod",
	            		dataType:'json',
	            		type:'post',
	            		data:data,
	            		error:function(){
