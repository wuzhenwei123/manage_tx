...
public class RSAUtils {
    ...
    public static String encrypt(String publicKey, String plainText) throws Exception {
        ...
        byte[] encryptData = encrypt(rsaPublicKey, plainTextData);
    ...
    public static String decrypt(String privateKey, String cipher) throws Exception {
        RSAPrivateKey rsaPrivateKey = loadPrivateKeyByStr(privateKey);
        byte[] cipherData = Base64.decode(cipher);
        byte[] decryptData = decrypt(rsaPrivateKey, cipherData);
