											...
											<div class="panel panel-plain">
												<div class="panel-heading">
													...
													<div class="panel-body">
														...
														<div class="form-group">
															<label class="control-label" for="areaCode">areaCode：</label>
															<input type="text" class="form-control" id="areaCode" name="areaCode">
														</div>
														<div class="form-group">
															<label class="control-label" for="areaName">areaName：</label>
											...
											<div class="panel panel-plain">
									    		...
									    		<div class="panel-body" style="padding-top: 0px;">
										    		<div class="row">
										            	<div class="col-sm-12">
											    			<div id="toolbar">
														    	<perm:tag permPath="/txArea/addTxArea" >
														    	<button type="button" onclick="to_add()" class="btn btn-primary">
															        <i class="glyphicon glyphicon-plus"></i>添加
															    </button>
																</perm:tag>
																<perm:tag permPath="/txArea/removeAllTxArea" >
															...
															<table id="table" data-toggle="table"
														        ...
														        data-url="${ctx}/txArea/getTxAreaList"
															    ...
															    <thead>
																    <tr>
																        ...
																        <th data-field="areaCode" data-align="center">areaCode</th>
																        <th data-field="areaName" data-align="center">areaName</th>
    ...
    <script type="text/javascript">
	    ...
	    function actionFormatter(value, row, index) {
	        return [
	            ...
	            '<perm:tag permPath="/txArea/updateTxArea" >',
	            '<a class="edit" href="javascript:void(0)" title="编辑">',
	            '<i class="glyphicon glyphicon-edit"></i>',
	            '</a> | ',
	            '</perm:tag>',
	            '<perm:tag permPath="/txArea/removeTxArea" >',
    	...
    	function toUpdate(id){
    		layer.open({
				title : "编辑",
			  	...
			  	area: ['60%', '80%'],
			  	shade: false,
			  	content: '${ctx}/txArea/toUpdate/'+id 
			 });
    	}
    	function del(id){
   		   if (id != ""){ 
   				$.post("<c:url value='/txArea/removeTxArea'/>",
	        	{
					id	:id,
					ranNum:Math.random()
				},
    	...
    	function del_all(){
   	    	...
   	    	if(ids && ids!=''){
	    		sys.confirm('确认全部删除',
	    				...
	    				'取消',
	    			function(){
	    	    	$.post("<c:url value='/txArea/removeAllTxArea'/>",
	            	{
