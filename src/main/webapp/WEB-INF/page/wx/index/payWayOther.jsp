...
<script>
    $(function () {
        ...
        $(".btn_boxs").on("click",function () {
        	...
        	if(id=="3"){
	       		location.href = "${ctx}/other/getListCard?PaymentInfo=${PaymentInfo}&fee=${fee}&paynumber=${paynumber}";
	       	}else if(id=="4"){
	       		location.href = "${ctx}/other/toUnionpay?_t="+Math.random()+"&PaymentInfo=${PaymentInfo}&fee=${fee}&paynumber=${paynumber}";
	       	}
        })
    })
</script>
