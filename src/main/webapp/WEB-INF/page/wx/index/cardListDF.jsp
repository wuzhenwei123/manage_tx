    ...
    $(function () {
        ...
        $(".btn_boxs").on("click",function () {
            ...
            if(typeof(accNo)=="undefined"){
            	...
            	if("addcard"==accNo){
            		 location.href = "${ctx}/index/toAddCardDF?_t="+Math.random()+"&sel_time=${sel_time}&backCard=${backCard}&money=${money}";
            	}else{
		            location.href = "${ctx}/index/toPayDF?accNo="+accNo+"&_t="+Math.random()+"&sel_time=${sel_time}&backCard=${backCard}&money=${money}";
            	}
            }
        })
    })
