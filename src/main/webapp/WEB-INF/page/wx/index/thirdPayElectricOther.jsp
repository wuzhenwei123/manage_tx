...
<script>
   function tijiao(){
		window.location.href = '${ctx}/other/toSelPayWayOther?PaymentInfo=${PaymentInfo}&fee=${fee}&paynumber=${paynumber}&cityCode=${cityCode}&loopID=${loopID}&ServiceType=${ServiceType}&centerSerial=${centerSerial}';
   }
</script>
</html>