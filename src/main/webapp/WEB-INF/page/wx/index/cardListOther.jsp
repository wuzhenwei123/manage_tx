    ...
    $(function () {
        ...
        $(".btn_boxs").on("click",function () {
            ...
            if(typeof(accNo)=="undefined"){
            	...
            	if("addcard"==accNo){
            		 location.href = "${ctx}/other/toAddCard?_t="+Math.random()+"&ordercode=${PaymentInfo}&fee=${fee}&cityCode=${cityCode}&loopID=${loopID}&ServiceType=${ServiceType}&paynumber=${paynumber}&centerSerial=${centerSerial}";
            	}else{
		            location.href = "${ctx}/other/toPay?accNo="+accNo+"&_t="+Math.random()+"&ordercode=${PaymentInfo}&fee=${fee}&cityCode=${cityCode}&loopID=${loopID}&ServiceType=${ServiceType}&paynumber=${paynumber}&centerSerial=${centerSerial}";
            	}
            }
        })
    })
