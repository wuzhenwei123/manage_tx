...
<script>
    $(function () {
        ...
        $(".btn_boxs").on("click",function () {
        	...
        	if(id=="3"){
	       		location.href = "${ctx}/index/getListCardDF?sel_time=${sel_time}&backCard=${backCard}&money=${money}";
	       	}else if(id=="4"){
	       		location.href = "${ctx}/index/toUnionpayDF?_t="+Math.random()+"&sel_time=${sel_time}&backCard=${backCard}&money=${money}";
	       	}
        })
    })
</script>
