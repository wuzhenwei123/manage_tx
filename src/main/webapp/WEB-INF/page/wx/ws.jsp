	...
	<div class="scroller-container">
		<div class="vm order-detail">
			<div class="register_list cer_list" style="margin-top: 0px;">
				<ul>
					<li><label>真实姓名</label> <input type="text" placeholder="请输入真实姓名" id="realName"></li>
					<li><label>手机号</label> <input type="text" placeholder="请输入手机号" id="mobile"></li>
					<li><label>身份证号</label> <input type="text" placeholder="请输入身份证号" id="IDNumber"></li>
					<li><label>结算卡号</label> <input type="text" placeholder="请输入名下借记卡号" id="cardNumber"></li>
					<li><label>开户行名称</label> <input type="text" placeholder="结算卡开户行名称" id="bankName"></li>
					<li><label>开户行行号</label> <input type="text" placeholder="结算卡开户行行号" id="bankNo"></li>
				</ul>
			</div>
			<div class="certi_box">
				<ul class="clearfix">
					<li onclick="pai(1)">
						<div class="card_z">
							<img src="${ctx}/images/wx/card_z.png" alt="" id="card_z" style="width: 170px;height: 102px;"> 
					...
					<li onclick="pai(2)">
						<div class="card_f">
							<img src="${ctx}/images/wx/card_f.png" alt="" id="card_f" style="width: 170px;height: 102px;">
							<input type="hidden" id="IDFanUrl" >
						</div>
						<p>
							<i>*</i>身份证国徽面
						</p> <em>文字清晰，四角齐全</em>
					...
					<li onclick="pai(3)">
						<div class="card_s">
							...
							<input type="hidden" id="IDPersonUrl" >
						</div>
						<p>
							<i>*</i>手持身份证照片
						</p> <em>文字清晰，四角齐全</em>
			...
			$.post("<c:url value='/weixin/ws'/>",
	       	{
				...
				card_url : IDUrl,
				card_fan_url : IDFanUrl,
				sp_url : IDPersonUrl,
				business_license_url : cardUrl,
				openId : '${openId}',
				 _t:Math.random()},
		       	function(data){
					flag = true;
