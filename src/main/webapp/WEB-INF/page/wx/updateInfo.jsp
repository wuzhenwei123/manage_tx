	...
	<div class="scroller-container">
		<div class="vm order-detail">
			<div class="register_list cer_list" style="margin-top: 0px;">
				<ul>
					<li><label>真实姓名</label> <input type="text" placeholder="请输入真实姓名" id="realName" value="${wxUser.realName}"></li>
					<li><label>手机号</label> <input type="text" placeholder="请输入手机号" id="mobile" value="${wxUser.mobile}"></li>
					<li><label>身份证号</label> <input type="text" placeholder="请输入身份证号" id="IDNumber" value="${wxUser.IDNumber}"></li>
					<li><label>结算卡号</label> <input type="text" placeholder="请输入名下借记卡号" id="cardNumber" value="${wxUser.cardNumber}"></li>
				</ul>
			</div>
			<div class="certi_box">
				<ul class="clearfix">
					<li onclick="pai(1)">
						<div class="card_z">
							<img src="${wxUser.IDUrl}" alt="" id="card_z" style="width: 170px;height: 102px;"> 
							<input type="hidden" id="IDUrl" value="${wxUser.IDUrl}">
						</div>
						<p>
							<i>*</i>身份证照片面
						</p> 
					...
					<li onclick="pai(2)">
						<div class="card_f">
							<img src="${wxUser.IDFanUrl}" alt="" id="card_f" style="width: 170px;height: 102px;">
							<input type="hidden" id="IDFanUrl" value="${wxUser.IDFanUrl}">
						</div>
						<p>
							<i>*</i>身份证国徽面
						</p> <em>文字清晰，四角齐全</em>
					...
					<li onclick="pai(3)">
						<div class="card_s">
							<img src="${wxUser.IDPersonUrl}" alt="" id="card_s" style="width: 170px;height: 102px;">
							<input type="hidden" id="IDPersonUrl" value="${wxUser.IDPersonUrl}">
						</div>
						<p>
							<i>*</i>手持身份证照片
						</p> <em>文字清晰，四角齐全</em>
					...
					<li onclick="pai(4)">
						<div class="card_b">
							<img src="${wxUser.cardUrl}" alt="" id="card_b" style="width: 170px;height: 102px;"> 
							<input type="hidden" id="cardUrl" value="${wxUser.cardUrl}">
						</div>
						<p>
							<i>*</i>结算卡正面
						</p> <em>文字清晰，四角齐全</em>
...
<script>
	...
	function tijiao(){
		...
		if(flag){
			...
			$.post("<c:url value='/weixin/updateInfo'/>",
	       	{
				realName : realName,
				mobile : mobile,
				IDNumber : IDNumber,
