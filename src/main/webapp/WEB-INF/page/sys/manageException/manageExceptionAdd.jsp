		...
		<div class="main-content">
			<section>
				<div class="container-fluid container-padded">
					<div class="row">
						<div class="col-md-12">
							<form id="add_form" action="${ctx}/manageException/addManageException" method="post" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" id="exception" name="exception" class="form-control"/>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label class="col-md-3 control-label">brief：</label>
									<div class="col-md-7">
										<input type="text" id="brief" name="brief" class="form-control"/>
									</div>
								</div>
								<div class="form-group">
