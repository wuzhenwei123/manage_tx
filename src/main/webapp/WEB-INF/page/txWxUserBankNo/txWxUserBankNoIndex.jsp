											...
											<div class="panel panel-plain">
												<div class="panel-heading">
													...
													<div class="panel-body">
														...
														<div class="form-group">
															<label class="control-label" for="wxUserId">wxUserId：</label>
															<input type="text" class="form-control" id="wxUserId" name="wxUserId">
														</div>
														<div class="form-group">
											...
											<div class="panel panel-plain">
									    		...
									    		<div class="panel-body" style="padding-top: 0px;">
										    		<div class="row">
										            	<div class="col-sm-12">
											    			<div id="toolbar">
														    	<perm:tag permPath="/txWxUserBankNo/addTxWxUserBankNo" >
														    	<button type="button" onclick="to_add()" class="btn btn-primary">
															        <i class="glyphicon glyphicon-plus"></i>添加
															    </button>
																</perm:tag>
																<perm:tag permPath="/txWxUserBankNo/removeAllTxWxUserBankNo" >
															...
															<table id="table" data-toggle="table"
														        ...
														        data-url="${ctx}/txWxUserBankNo/getTxWxUserBankNoList"
															    ...
															    <thead>
																    <tr>
																        ...
																        <th data-field="wxUserId" data-align="center">wxUserId</th>
																        <th data-field="accNo" data-align="center">accNo</th>
																        <th data-field="token" data-align="center">token</th>
    ...
    <script type="text/javascript">
	    ...
	    function actionFormatter(value, row, index) {
	        return [
	            ...
	            '<perm:tag permPath="/txWxUserBankNo/updateTxWxUserBankNo" >',
	            '<a class="edit" href="javascript:void(0)" title="编辑">',
	            '<i class="glyphicon glyphicon-edit"></i>',
	            '</a> | ',
	            '</perm:tag>',
	            '<perm:tag permPath="/txWxUserBankNo/removeTxWxUserBankNo" >',
    	...
    	function to_add(){
    		layer.open({
				title : "添加",
			  	...
			  	area: ['60%', '80%'],
			  	shade: false,
			  	content: '${ctx}/txWxUserBankNo/toAdd'
			 });
    	}
    	function toUpdate(id){
    		layer.open({
				title : "编辑",
			  	...
			  	area: ['60%', '80%'],
			  	shade: false,
			  	content: '${ctx}/txWxUserBankNo/toUpdate/'+id 
			 });
    	}
    	function del(id){
   		   if (id != ""){ 
   				$.post("<c:url value='/txWxUserBankNo/removeTxWxUserBankNo'/>",
	        	{
					id	:id,
					ranNum:Math.random()
				},
    	...
    	function del_all(){
   	    	...
   	    	if(ids && ids!=''){
	    		sys.confirm('确认全部删除',
	    				...
	    				'取消',
	    			function(){
	    	    	$.post("<c:url value='/txWxUserBankNo/removeAllTxWxUserBankNo'/>",
	            	{
