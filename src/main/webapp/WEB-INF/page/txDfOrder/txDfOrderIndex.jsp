...
<body>
											...
											<div class="panel panel-plain">
												<div class="panel-heading">
													...
													<div class="panel-body">
														...
														<div class="form-group">
															<label class="control-label" for="orderCode">orderCode：</label>
														...
														<div class="form-group">
															<label class="control-label" for="orderTime">orderTime：</label>
											...
											<div class="panel panel-plain">
									    		...
									    		<div class="panel-body" style="padding-top: 0px;">
										    		<div class="row">
										            	<div class="col-sm-12">
											    			<div id="toolbar">
														    	<perm:tag permPath="/txDfOrder/addTxDfOrder" >
														    	<button type="button" onclick="to_add()" class="btn btn-primary">
															        <i class="glyphicon glyphicon-plus"></i>添加
															    </button>
																</perm:tag>
																<perm:tag permPath="/txDfOrder/removeAllTxDfOrder" >
															...
															<table id="table" data-toggle="table"
														        ...
														        data-url="${ctx}/txDfOrder/getTxDfOrderList"
															    ...
															    <thead>
																    <tr>
																        ...
																        <th data-field="realName" data-align="center">realName</th>
																        <th data-field="orderCode" data-align="center">orderCode</th>
																        ...
																        <th data-field="orderTime" data-sort-name="orderTime" data-align="center" data-formatter="formatterOrderTime" data-sortable="true">orderTime</th>
    ...
    <script type="text/javascript">
		...
		$(document).ready(function() {
	    	...
	    	P.init_date("query_form","orderTime");
	    });
    	//检索入口
    	function search(){
	    ...
	    function actionFormatter(value, row, index) {
	        return [
	            ...
	            '<perm:tag permPath="/txDfOrder/updateTxDfOrder" >',
	            '<a class="edit" href="javascript:void(0)" title="编辑">',
	            '<i class="glyphicon glyphicon-edit"></i>',
	            '</a> | ',
	            '</perm:tag>',
	            '<perm:tag permPath="/txDfOrder/removeTxDfOrder" >',
    	...
    	function toUpdate(id){
    		layer.open({
				title : "编辑",
			  	...
			  	area: ['60%', '80%'],
			  	shade: false,
			  	content: '${ctx}/txDfOrder/toUpdate/'+id 
			 });
    	}
    	function del(id){
   		   if (id != ""){ 
   				$.post("<c:url value='/txDfOrder/removeTxDfOrder'/>",
	        	{
					id	:id,
					ranNum:Math.random()
				},
    	...
    	function del_all(){
   	    	...
   	    	if(ids && ids!=''){
	    		sys.confirm('确认全部删除',
	    				...
	    				'取消',
	    			function(){
	    	    	$.post("<c:url value='/txDfOrder/removeAllTxDfOrder'/>",
	            	{
	    ...
	    function formatterOrderTime(orderTime){
	    	return getFormatDateByLong(orderTime,"yyyy-MM-dd");
	    }
	    /**
	     * 获取表格checkbox
	     * @returns
