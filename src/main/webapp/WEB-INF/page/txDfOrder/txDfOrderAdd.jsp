...
<body class="dig-body">
		...
		<div class="main-content">
			<section>
				<div class="container-fluid container-padded">
					<div class="row">
						<div class="col-md-12">
							<form id="add_form" action="${ctx}/txDfOrder/addTxDfOrder" method="post" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" readonly="readonly" id="orderTime" name="orderTime" class="form-control"/>
									</div>
								</div>
								<div class="form-group">
	...
	<script type="text/javascript">
		$(document).ready(function() {
	    	...
	    	P.init_date("add_form","orderTime");
