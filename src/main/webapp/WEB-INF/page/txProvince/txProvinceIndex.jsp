											...
											<div class="panel panel-plain">
												<div class="panel-heading">
													...
													<div class="panel-body">
														...
														<div class="form-group">
															<label class="control-label" for="provinceCode">provinceCode：</label>
															<input type="text" class="form-control" id="provinceCode" name="provinceCode">
														</div>
														<div class="form-group">
															<label class="control-label" for="provinceName">provinceName：</label>
											...
											<div class="panel panel-plain">
									    		...
									    		<div class="panel-body" style="padding-top: 0px;">
										    		<div class="row">
										            	<div class="col-sm-12">
											    			<div id="toolbar">
														    	<perm:tag permPath="/txProvince/addTxProvince" >
														    	<button type="button" onclick="to_add()" class="btn btn-primary">
															        <i class="glyphicon glyphicon-plus"></i>添加
															    </button>
																</perm:tag>
																<perm:tag permPath="/txProvince/removeAllTxProvince" >
															...
															<table id="table" data-toggle="table"
														        ...
														        data-url="${ctx}/txProvince/getTxProvinceList"
															    ...
															    <thead>
																    <tr>
																        ...
																        <th data-field="provinceCode" data-align="center">provinceCode</th>
																        <th data-field="provinceName" data-align="center">provinceName</th>
    ...
    <script type="text/javascript">
	    ...
	    function actionFormatter(value, row, index) {
	        return [
	            ...
	            '<perm:tag permPath="/txProvince/updateTxProvince" >',
	            '<a class="edit" href="javascript:void(0)" title="编辑">',
	            '<i class="glyphicon glyphicon-edit"></i>',
	            '</a> | ',
	            '</perm:tag>',
	            '<perm:tag permPath="/txProvince/removeTxProvince" >',
    	...
    	function toUpdate(id){
    		layer.open({
				title : "编辑",
			  	...
			  	area: ['60%', '80%'],
			  	shade: false,
			  	content: '${ctx}/txProvince/toUpdate/'+id 
			 });
    	}
    	function del(id){
   		   if (id != ""){ 
   				$.post("<c:url value='/txProvince/removeTxProvince'/>",
	        	{
					id	:id,
					ranNum:Math.random()
				},
    	...
    	function del_all(){
   	    	...
   	    	if(ids && ids!=''){
	    		sys.confirm('确认全部删除',
	    				...
	    				'取消',
	    			function(){
	    	    	$.post("<c:url value='/txProvince/removeAllTxProvince'/>",
	            	{
